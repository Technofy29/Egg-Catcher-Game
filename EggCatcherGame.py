...
# itertools --> change color , design of egg and catcher
# random --->  using this eggs randomly appears on the screen
# tkinter ---> it basically animates game on the screen 
...
#setting the size , color , speed of catcher and egg
